...
ag8_40323137b = Blueprint('ag8_40323137b', __name__, url_prefix='/ag8_40323137b', template_folder='templates')

# scrum1_task1 為完整可以單獨執行的繪圖程式
@ag8_40323137b.route('/task1')
def task1():
    outstring = '''
<!DOCTYPE html>
<html>
...
O(0, 20, 0, 0, 0, "lightgreen", True, 4)
</script>
<!-- 以協同方式加上 ag100 的 scrum-2 組員所寫的 task1 程式碼 -->
<script type="text/python" src="/ag8_40323137a/task1"></script>
